...
export default function PrivacyPage() {
  return (
    <div className="container-custom py-12 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold text-[var(--foreground)] mb-4">Политика за поверителност</h1>
      <p className="text-[var(--muted)] mb-8">Последна актуализация: {new Date().toLocaleDateString('bg-BG')}</p>
      ...
      <div className="bg-amber-50 rounded-xl p-6 mb-10 shadow-sm border border-amber-100">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-lg font-semibold text-[var(--foreground)] mb-3">Накратко за Вашите данни</h2>
      ...
      <div className="space-y-10">
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-[var(--muted)] uppercase tracking-wide mb-2">Събиране на данни</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[var(--foreground)] mb-3">2. Какви данни събираме</h2>
                <p className="text-[var(--foreground)] mb-4">
                  Събираме следните категории лични данни:
                </p>
                <ul className="list-disc pl-6 text-[var(--foreground)] space-y-1">
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-[var(--muted)] uppercase tracking-wide mb-2">Обработка и правно основание</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[var(--foreground)] mb-3">3. Цели на обработване</h2>
                <p className="text-[var(--foreground)] mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[var(--foreground)] mb-3">4. Правно основание</h2>
                <p className="text-[var(--foreground)] mb-4">
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-[var(--muted)] uppercase tracking-wide mb-2">Вашите права</h3>
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-green-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[var(--foreground)] mb-3">5. Срок на съхранение</h2>
                <p className="text-[var(--foreground)] mb-4">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-green-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[var(--foreground)] mb-3">6. Вашите права</h2>
                <p className="text-[var(--foreground)] mb-4">
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-[var(--muted)] uppercase tracking-wide mb-2">Сигурност и трети страни</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[var(--foreground)] mb-3">7. Споделяне на данни</h2>
                <p className="text-[var(--foreground)] mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[var(--foreground)] mb-3">8. Сигурност на данните</h2>
                <p className="text-[var(--foreground)] mb-4">
        ...
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-[var(--muted)] uppercase tracking-wide mb-2">Жалби и актуализации</h3>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[var(--foreground)] mb-3">9. Жалби</h2>
                <p className="text-[var(--foreground)] mb-4">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border border-gray-100">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-[var(--foreground)] mb-3">10. Промени в политиката</h2>
