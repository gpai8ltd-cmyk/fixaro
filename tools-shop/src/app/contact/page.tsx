        ...
        {channelCards.map((card) => {
          ...
          return (
            ...
            >
              ...
              <h3 className="font-semibold text-[var(--foreground)] mb-1">{card.title}</h3>
              <p className="text-[var(--foreground)] font-medium text-sm mb-0.5">{card.value}</p>
              <p className="text-[var(--muted)] text-sm mb-4">{card.subtext}</p>
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div>
                <label className="block text-sm font-medium text-[var(--foreground)] mb-2">Име *</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div>
                <label className="block text-sm font-medium text-[var(--foreground)] mb-2">Имейл *</label>
                <input
                  type="email"
                  name="email"
            ...
            <div className="grid md:grid-cols-2 gap-5">
              <div>
                <label className="block text-sm font-medium text-[var(--foreground)] mb-2">Телефон</label>
                <input
                  type="tel"
                  name="phone"
              ...
              <div>
                <label className="block text-sm font-medium text-[var(--foreground)] mb-2">Относно</label>
                <select
                  name="subject"
            ...
            <div>
              <label className="block text-sm font-medium text-[var(--foreground)] mb-2">Съобщение *</label>
              <textarea
                name="message"
        ...
        <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-100">
          <div className="bg-gradient-to-br from-slate-100 to-slate-200 h-[350px] flex items-center justify-center">
            <div className="text-center p-6">
              ...
              <p className="text-[var(--foreground)] font-medium text-lg mb-1">
                гр. София
              </p>
              <p className="text-[var(--muted)] mb-6">
