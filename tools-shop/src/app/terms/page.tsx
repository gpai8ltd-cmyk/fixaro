...
export default function TermsPage() {
  ...
  return (
    <div className="container-custom py-12">
      <h1 className="text-3xl font-bold text-[var(--foreground)] mb-4">Общи условия</h1>
      ...
      <div className="lg:flex lg:gap-8">
        ...
        <div className="lg:hidden mb-6">
          <button
            ...
            className="flex items-center gap-2 w-full px-4 py-3 bg-amber-50 rounded-xl shadow-sm text-[var(--foreground)] font-medium"
          >
                    ...
                    <button
                      ...
                      className={`block w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                        activeSection === section.id
                          ...
                          : 'text-[var(--foreground)] hover:bg-amber-100'
                      }`}
                    >
                      {section.title}
                    </button>
        ...
        <aside className="hidden lg:block lg:w-72 flex-shrink-0">
          <nav className="sticky top-24 p-5 bg-amber-50 rounded-xl shadow-sm">
            <h2 className="font-semibold text-[var(--foreground)] mb-4">Съдържание</h2>
        ...
        <main className="flex-1 space-y-4">
          ...
          <div id="section-1" className="bg-amber-50/50 rounded-xl shadow-sm overflow-hidden scroll-mt-24">
            ...
            >
              <h2 className="text-xl font-semibold text-[var(--foreground)]">1. Общи положения</h2>
              <ChevronDown
          ...
          <div id="section-2" className="bg-amber-50/50 rounded-xl shadow-sm overflow-hidden scroll-mt-24">
            <button
              ...
              className="flex items-center justify-between w-full p-5 text-left"
            >
              <h2 className="text-xl font-semibold text-[var(--foreground)]">2. Поръчка и сключване на договор</h2>
              <ChevronDown
                className={`w-5 h-5 text-[var(--muted)] transition-transform duration-200 ${
          ...
          <div id="section-3" className="bg-amber-50/50 rounded-xl shadow-sm overflow-hidden scroll-mt-24">
            <button
              ...
              className="flex items-center justify-between w-full p-5 text-left"
            >
              <h2 className="text-xl font-semibold text-[var(--foreground)]">3. Цени и плащане</h2>
              <ChevronDown
                className={`w-5 h-5 text-[var(--muted)] transition-transform duration-200 ${
          ...
          <div id="section-4" className="bg-amber-50/50 rounded-xl shadow-sm overflow-hidden scroll-mt-24">
            <button
              ...
              className="flex items-center justify-between w-full p-5 text-left"
            >
              <h2 className="text-xl font-semibold text-[var(--foreground)]">4. Гаранция</h2>
              <ChevronDown
                className={`w-5 h-5 text-[var(--muted)] transition-transform duration-200 ${
          ...
          <div id="section-5" className="bg-amber-50/50 rounded-xl shadow-sm overflow-hidden scroll-mt-24">
            <button
              ...
              className="flex items-center justify-between w-full p-5 text-left"
            >
              <h2 className="text-xl font-semibold text-[var(--foreground)]">5. Интелектуална собственост</h2>
              <ChevronDown
                className={`w-5 h-5 text-[var(--muted)] transition-transform duration-200 ${
          ...
          <div id="section-6" className="bg-amber-50/50 rounded-xl shadow-sm overflow-hidden scroll-mt-24">
            <button
              ...
              className="flex items-center justify-between w-full p-5 text-left"
            >
              <h2 className="text-xl font-semibold text-[var(--foreground)]">6. Ограничение на отговорността</h2>
              <ChevronDown
                className={`w-5 h-5 text-[var(--muted)] transition-transform duration-200 ${
          ...
          <div id="section-7" className="bg-amber-50/50 rounded-xl shadow-sm overflow-hidden scroll-mt-24">
            <button
              ...
              className="flex items-center justify-between w-full p-5 text-left"
            >
              <h2 className="text-xl font-semibold text-[var(--foreground)]">7. Изменения на Общите условия</h2>
              <ChevronDown
                className={`w-5 h-5 text-[var(--muted)] transition-transform duration-200 ${
          ...
          <div id="section-8" className="bg-amber-50/50 rounded-xl shadow-sm overflow-hidden scroll-mt-24">
            <button
              ...
              className="flex items-center justify-between w-full p-5 text-left"
            >
              <h2 className="text-xl font-semibold text-[var(--foreground)]">8. Приложимо право</h2>
              <ChevronDown
                className={`w-5 h-5 text-[var(--muted)] transition-transform duration-200 ${
          ...
          <div id="section-9" className="bg-amber-50/50 rounded-xl shadow-sm overflow-hidden scroll-mt-24">
            <button
              ...
              className="flex items-center justify-between w-full p-5 text-left"
            >
              <h2 className="text-xl font-semibold text-[var(--foreground)]">9. Контакт</h2>
              <ChevronDown
                className={`w-5 h-5 text-[var(--muted)] transition-transform duration-200 ${
